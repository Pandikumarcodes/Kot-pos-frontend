...
export default function SignUpPage() {
  ...
  const handleTermsClick = () => {
    alert("Terms and Conditions page coming soon!");
    // navigate('/terms');
  };
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-kot-lg p-8">
          ...
          <div className="text-center mb-8">
            <div className="inline-block p-3 bg-kot-stats rounded-full mb-4">
              <svg
            ...
            <h1 className="text-3xl font-bold text-kot-darker mb-2">
              Create Account
            </h1>
            <p className="text-kot-text">
              Join KOT and start your journey today.
            </p>
          </div>
          ...
          <div className="space-y-5">
            ...
            {formData.password && (
              <div className="space-y-2">
                <p className="text-xs text-kot-text">Password strength:</p>
                ...
                <ul className="text-xs text-kot-text space-y-1">
                  <li
                    className={
            ...
            <div>
              <label className="flex items-start cursor-pointer group">
                <input
                  ...
                  className="w-4 h-4 mt-1 text-kot-dark border-gray-300 rounded focus:ring-kot-dark cursor-pointer"
                />
                <span className="ml-2 text-sm text-kot-text group-hover:text-kot-dark transition-colors">
                  I agree to the{" "}
                  <button
                    onClick={handleTermsClick}
                    className="text-kot-dark hover:text-kot-darker underline font-medium"
                  >
                    Terms and Conditions
                  </button>{" "}
                  and{" "}
