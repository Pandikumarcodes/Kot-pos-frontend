...
import type { BillPayload } from "../../services/notificationServices";
import GSTInvoice from "../../Bill/GstInvoice";
...
export default function BillingPage() {
  ...
  useNotifications({
    "billing:created": (bill: BillPayload) => {
      if (activeTab === "bills")
        setBills((prev) =>
          prev.some((b) => b._id === bill._id)
            ? prev
            : [bill as unknown as Bill, ...prev],
        );
    },
  });
  ...
  return (
    <div className="min-h-screen bg-kot-primary">
      <div className="max-w-[2400px] mx-auto p-3 sm:p-4 lg:p-6 xl:p-8 space-y-3 sm:space-y-4 lg:space-y-5">
            ...
            {step === "order" && (
              <div className="relative">
                ...
                >
                  ...
                  {/* Order Panel — hidden on mobile (shown as overlay), visible sm+ */}
                  <div
                    className={`
                    sm:w-64 lg:w-72 xl:w-80 bg-kot-white rounded-2xl shadow-kot flex flex-col flex-shrink-0
                    fixed inset-0 z-50 sm:static sm:z-auto
        ...
        {activeTab === "bills" && (
          <div className="flex flex-col lg:flex-row gap-3 sm:gap-4">
            ...
            {/* Bill Detail — bottom sheet on mobile, sidebar on lg+ */}
            {selectedBill && (
              <>
                <div
                ...
                <div
                  ...
                  lg:w-80 xl:w-96 bg-kot-white shadow-kot flex-shrink-0
                `}
                >
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <button
                      onClick={() => setInvoiceBill(selectedBill)}
      ...
      {invoiceBill && (
        <GSTInvoice bill={invoiceBill} onClose={() => setInvoiceBill(null)} />
      )}
    </div>
  );
}
