...
import { TableQrCode } from "../../../components/ui/TableQrCode";
        ...
        >
          ...
          >
            ...
            <form onSubmit={onAddTable} className="p-4 sm:p-6 space-y-4">
              <div>
                <label htmlFor="table-number" className="block text-sm font-semibold text-kot-darker mb-1">
                  Table Number *
                </label>
                <input
                  id="table-number"
              ...
              <div>
                <label htmlFor="table-capacity" className="block text-sm font-semibold text-kot-darker mb-1">
                  Capacity *
                </label>
                <input
                  id="table-capacity"
        ...
        <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
          <div className="bg-kot-white rounded-t-3xl sm:rounded-2xl shadow-kot-lg w-full sm:max-w-sm">
            ...
            <form onSubmit={onAllocate} className="p-4 sm:p-6 space-y-4">
              <div>
                <label htmlFor="allocation-customer-name" className="block text-sm font-semibold text-kot-darker mb-1">
                  Customer Name *
                </label>
                <input
                  id="allocation-customer-name"
                  type="text"
                  required
              ...
              <div>
                <label htmlFor="allocation-customer-phone" className="block text-sm font-semibold text-kot-darker mb-1">
                  Phone Number *
                </label>
                <input
                  id="allocation-customer-phone"
                  type="tel"
                  required
