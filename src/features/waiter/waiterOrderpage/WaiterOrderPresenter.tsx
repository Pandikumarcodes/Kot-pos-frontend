...
export function WaiterOrderPresenter({
  ...
  return (
    <div className="min-h-screen bg-kot-primary">
      <div className="max-w-[2400px] mx-auto p-3 sm:p-4 lg:p-6 xl:p-8 space-y-3 sm:space-y-4">
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <button
            ...
            className="w-fit flex items-center gap-1.5 px-3 py-2 rounded-xl border-2 border-kot-chart text-kot-dark bg-kot-white hover:bg-kot-light text-sm"
          >
          ...
          <div className="space-y-3">
            ...
            {allItems.length > 0 && (
              <p className="text-xs text-kot-text text-center">
                💡 Use "Add More Items" for each new round. Click "Send to
                Cashier" only when the customer is done eating.
              </p>
            )}
          </div>
        )}
        ...
        {view === "menu" && (
          <div className="relative">
            ...
            >
              ...
              {/* Cart panel */}
              <div
                className={`sm:w-64 lg:w-72 xl:w-80 bg-kot-white rounded-2xl shadow-kot flex flex-col flex-shrink-0 fixed inset-0 z-50 sm:static sm:z-auto transition-transform duration-300 ${
                  showOrderPanel
                    ? "translate-y-0"
              ...
              >
                <div className="p-3 sm:p-4 border-b border-kot-chart bg-kot-light rounded-t-2xl flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="sm:hidden p-1 text-kot-text"
                  >
                    <X size={18} />
                  </button>
                </div>
